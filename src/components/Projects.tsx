...
function MobileProjectsCarousel({
  ...
  return (
    <div ref={containerRef} className="block md:hidden w-full overflow-hidden">
      ...
      >
        <div ref={emblaRef} className="overflow-hidden cursor-grab active:cursor-grabbing -my-8 py-8 -mx-4 px-4 sm:-mx-6 sm:px-6">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="flex-1 text-center sm:text-left px-2 sm:px-4 relative z-10">
            <h4
              className={`font-display font-semibold text-xl sm:text-2xl md:text-[23px] tracking-tight leading-snug ${
